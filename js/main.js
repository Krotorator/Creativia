...
(function () {
    ...
    $('.acc__title').on('click', function(){
        $('.acc__title').not(this).siblings().slideUp();
        $(this).siblings().slideToggle();
        $(this).children().toggleClass('acc--active');
        $(this).toggleClass('acc__title--active');
        $('.acc__title').not(this).removeClass('acc__title--active');

        if ($('.acc__title').not(this).children('.acc__minus').hasClass('acc--active')) {
            $('.acc__title').not(this).children('.acc__minus').removeClass('acc--active');
            $('.acc__title').not(this).children('.acc__plus').addClass('acc--active');
        }; 
    })
